...
module FourDigitLEDdriver(reset, clk, btn, an3, an2, an1, an0, char);
    input reset, clk, btn;
    output reg [3:0] char;
    ...
    // Memory module with message stored and
    // FSM for the characters that need to be shown.
    Memory msg_mem (clk, reset, btn, char0, char1, char2, char3);
