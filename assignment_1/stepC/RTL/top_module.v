...
module top_module(clk, reset, btn, a, b, c, d, e, f, g, dp, an0, an1, an2, an3);
    input clk, reset, btn;
    ...
    wire [7:0] LED;
    wire [3:0] char;
    wire clk_out, db_out_rst, db_out_btn, sync_tmp_rst, sync_out_rst, sync_tmp_btn, sync_out_btn;

    // The New modulated clock that our circuit runs at.
    MMCM clock_5M (clk, clk_out);

    // Synchronizer and de-bounce mechanisms for reset and button signals.
    ...
    Synchronizer sync_mod_btn (clk_out, btn, sync_tmp_btn, sync_out_btn);
    Debounce debounce_mod_btn (clk_out, sync_out_btn, sync_tmp_btn, db_out_btn);    

    // The driver for the four 7-segment displays.
    FourDigitLEDdriver driver_mod (db_out_rst, clk_out, db_out_btn, an3, an2, an1, an0, char);
