...
module Memory (clk, rst, D_out0, D_out1, D_out2, D_out3);
    input clk, rst;
    output reg [3:0] D_out0, D_out1, D_out2, D_out3;

    parameter BIT_LENGTH = 23;
    parameter max_cnt = {BIT_LENGTH{1'b1}};

    reg [3:0] addr;
    reg [3:0] mem [0:15];
    reg [BIT_LENGTH:0] cnt;
